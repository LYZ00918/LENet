...
class SegmentationMetric(object):
    ...
    def genConfusionMatrix(self, imgPredit, imgLabel):
        ...
        confusionMatrix = confusionMatrix[0:index, 0:index]
...
# PPNet_S_KD(CE[S,T]_AT_KL)  PPNet_S_KD(CE[S,T]_COS(11-13))
if __name__ == '__main__':
    # pre_path = '/home/panyi/桌面/pytorch_segementation_Remote_Sensing/results/{}/DGPINet_kd_1/'.format(DATASET)
    pre_path = '/home/panyi/桌面/pytorch_segementation_Remote_Sensing/toolbox/models/SXY/run/2024-10-08-21-12(SXY_kd_V)/result_val/'
    # pre_path = '/home/panyi/桌面/pytorch_segementation_Remote_Sensing/run/2024-04-28-09-35(paper3_26(lwa_cluster_VID(b*c_H*W)))/result_val/'
    # pre_path = '/home/panyi/桌面/pytorch_segementation_Remote_Sensing/toolbox/models/lyz/results/{}/SFAFMA_T/'.format(DATASET)
    # label_path = '/home/panyi/桌面/ISPRS/test/{}/'.format(DATASET)
    label_path = '/media/panyi/dd67419f-4b06-4cc1-a57e-0706577875076/ISPRS/test/{}/'.format(DATASET)
